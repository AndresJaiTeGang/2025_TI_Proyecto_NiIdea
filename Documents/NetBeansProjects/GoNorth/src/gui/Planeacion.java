...
public class Planeacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblHOME.setBackground(new java.awt.Color(255, 204, 0));
        ...
        lblComplexNumbers.setForeground(new java.awt.Color(255, 204, 0));
        lblComplexNumbers.setText("Planeación de actividades");
        pnlComplexNumbers.add(lblComplexNumbers, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 20, 470, 50));
        ...
        lblTema1.setText("Aplica el gráfico de Gantt en la planeación de un proyecto e identifica la ruta crítica para el control, la optimización del tiempo de duración del proyecto y los costos involucrados en la realización del mismo. ");
        pnlComplexNumbers.add(lblTema1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, 720, 30));

        lblFoot.setForeground(new java.awt.Color(255, 204, 0));
        ...
        lblFoot1.setForeground(new java.awt.Color(255, 204, 0));
        ...
        lblIndicacion1.setText("Indicaciones: Se desarrolla un diagrama de Gantt para representar el orden de preparación de una hamburguesa.");
        pnlComplexNumbers.add(lblIndicacion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 120, 730, 20));

        solution.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/4.probPlan.jpg"))); // NOI18N
        pnlComplexNumbers.add(solution, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 490, 290));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Plan.png"))); // NOI18N
        jLabel1.setText("jLabel1");
        pnlComplexNumbers.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 90, 90));

        jLabel2.setText("jLabel2");
        pnlComplexNumbers.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, -4, 100, 190));
    ...
    private void lblHOMEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblHOMEMouseClicked
        // TODO add your handling code here:
        main.Planeacion.setVisible(false);
        main.Planeacion = null;
